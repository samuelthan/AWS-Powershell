...
$ProdEC2Volumes = Import-csv C:\Temp\Prod-EC2Volumes.csv
$ProdECSnapshots = Import-csv C:\Temp\Prod-EC2SnapShots.csv


$Result = Join-Object -Left $ProdEC2Volumes -Right $ProdECSnapshots -LeftJoinProperty VolumeId -RightJoinProperty VolumeId -Type AllInBoth -Prefix RR__

#$Result | Out-GridView

$Result | Export-CSV -Path C:\Temp\Prod-EC2Details.csv -Encoding ascii -NoTypeInformation